...
public class MusicList {
    ...
    private static final List<Song> SONGS = Arrays.asList(
        ...
        new Song("[Viet] Waiting For You - MONO",
            "Im waiting for you every single night | Staring at the ceiling thinking of you",
        ...
        new Song("[Pop] Blinding Lights - The Weeknd",
            "Ive been tryna call Im in your walls | Ive been running through the night",
            "minecraft:music.creative", "pop"),
        new Song("[Pop] Shape of You - Ed Sheeran",
            "The club isnt the best place to find a lover | So the bar is where I go",
        ...
        new Song("[Pop] Levitating - Dua Lipa",
            "I got you moonlight youre my starlight | I need you all night come on dance with me",
            "minecraft:music.game", "pop"),
        new Song("[Pop] Stay - Justin Bieber",
            "I do not wanna fall in love | If I ever did that I think Id have a heart attack",
            "minecraft:music.menu", "pop"),
        new Song("[Pop] Someone Like You - Adele",
            "Never mind Ill find someone like you | I wish nothing but the best for you",
        ...
        new Song("[Pop] Sunflower - Post Malone",
            "Every time Im leavin on you | You dont make it easy no",
            "minecraft:music.game", "pop"),
        ...
        new Song("[Rock] Stressed Out - Twenty One Pilots",
            "I wish I found some better sounds no ones ever heard | I wish I had a better voice that sang some better words",
            "minecraft:music.game", "rock"),
